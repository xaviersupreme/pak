...
static void usage(FILE *out)
{
    ...
    fprintf(out, "  pak [--v|--verbose] extract [-C dir] [--overwrite|--skip-existing] <archive.pak>\n");
    fprintf(out, "  pak [--v|--verbose] info <archive.pak>\n");
    fprintf(out, "  pak [--v|--verbose] verify <archive.pak>\n");
}
...
{
    return strcmp(arg, "make") == 0 || strcmp(arg, "list") == 0 || strcmp(arg, "extract") == 0 || strcmp(arg, "info") == 0 || strcmp(arg, "verify") == 0;
}
...
int main(int argc, char **argv)
{
    ...
    if (strcmp(args[0], "make") == 0) {
        ...
        rc = count == 2 ? pak_extract(args[1], &opts) : 1;
    ...
    if (rc != 0 && (strcmp(args[0], "list") == 0 || strcmp(args[0], "extract") == 0 || strcmp(args[0], "info") == 0 || strcmp(args[0], "verify") == 0) && count != 2) {
        usage(stderr);
    }
